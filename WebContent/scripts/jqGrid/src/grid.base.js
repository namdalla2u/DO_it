        ...
        setGridWidth: function (nwidth, shrink) {
            return this.each(function () {
                ...
                var $t = this, cw,
                    ...
                    scw = $t.p.scrollOffset, aw, gw = 0, cr, bstw = $t.p.styleUI.search('Bootstrap') !== -1 ? 2 : 0;
                            ...
                            if (nData !== "" || forceupd === true) {
                                if ($t.p.datatype === 'local') {
                                    ...
                                    while (cl < ind.cells.length) {
                                        // slow down speed
                                        v = $.unformat.call($t, $(ind.cells[cl]), {
                                            rowId: ind.id,
                                            colModel: $t.p.colModel[cl]
                                        }, cl);
                                        rawdat.push(v);
                                        cl++;
                                    }
            ...
            return this.each(function () {
                ...
                switch (p.loadtype) {
                    ...
                    case "enable":
                        ...
                        break;
                    case "block":
                        $("#lui_" + $.jgrid.jqID(this.p.id)).css(sh ? {
                            top: 0,
                            left: 0,
