...
public class EmailManagement extends AbstractController{
	...
	public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response){
		...
		String host = null; 
		final String username = "seoulittest1";  // 발송 메일 주소
		final String password = "testtest1";  // 발송 메일 비밀번호
		String pdfBaseUrl = "C:\\Users\\wooya\\project\\HoWooAccount\\WebContent\\resources\\reportform\\report11.pdf";
		// 본인 pdf 파일 저장 위치로 경로 변경하세요!
...
String recipient = email+"@"+emailOption; // 받는 사람의 이메일
		...
		msg.setFrom(new InternetAddress("seoulittest1@naver.com","HoWooAccount")); // 2번째 문자열은 발송자 이름입니다. 변경하세요
