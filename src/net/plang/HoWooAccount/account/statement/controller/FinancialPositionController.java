...
public class FinancialPositionController extends AbstractController {
    ...
    public ModelAndView handleRequestInternal(HttpServletRequest request, HttpServletResponse response) {
        if (logger.isDebugEnabled()) {
            logger.debug(" FinancialPositionController : handleRequestInternal 시작 ");
        }

        JSONObject json = new JSONObject();
        System.out.println("		@ FinancialPositionController 접근");
        try {
            ...
            json.put("financialPosition", financialPosition.get("financialPosition"));
        ...
        if (logger.isDebugEnabled()) {
            logger.debug(" FinancialPositionController : handleRequestInternal 종료 ");
        }
        return null;
    }
